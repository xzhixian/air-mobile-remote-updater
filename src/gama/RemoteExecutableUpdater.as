package gama
{
	...
	public class RemoteExecutableUpdater
	{
		 ...
		 */
		static public function start(localVersion:int ,
									 localExecutable:File ,
									 remoteVersionUrl:String ,
									 initParameters:Object = null ,
									 customRemoteExecutableUrl:String = null):void
		{
			...
			if (isBusy)
			{
				dispatcher.dispatchEvent(new ErrorEvent(ErrorEvent.ERROR ,
														false ,
														false ,
														"RemoteExecutableUpdater is running"));
				return;
			}
...
//					loader = null;
									...
									function(event:Event):void
			{
				...
				if (looksNotLikePureNumber)
				{
					...
					try
					{
						...
						_remoteExecutableUrl = _remoteExecutableUrl ||
				(obj['url'] || obj['uri'] || obj['swf'] || obj['client'])
		...
		{
			trace("[RemoteExecutableUpdater.compareVersion] _localVersion:" + _localVersion + "; _localCachedVersion:" +
			_localCachedVersion + "; _remoteVersion:" + _remoteVersion);
		 ...
		 * 读取本地缓存的 swf 文件
		 */
		public static function loadLocalCachedExecutable():void
		{
